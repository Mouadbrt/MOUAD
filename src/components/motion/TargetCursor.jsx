...
// Adapted from reactbits.dev/animations/target-cursor — a reticle cursor
// whose four corners snap onto whatever element under the pointer matches
// `targetSelector`, sizing themselves to that element's own bounding box
// (a button gets a tight bracket, a project card gets a big one, no manual
// per-target scale needed). Idles in a slow spin between targets.
...
export default function TargetCursor({
  ...
  return (
    <div ref={cursorRef} aria-hidden="true" className="target-cursor-wrapper">
